  ...
  return (
    ...
    >
      ...
      >
        ...
        <Gap />
        <DamageCheckList out dataSet={dataSet} handleChange={handleChange} />
        <Gap />
        <Accessories out dataSet={dataSet} handleChange={handleChange} />
        <Gap />
        <Tyres out dataSet={dataSet} handleChange={handleChange} />
        <Gap />
        <Remark out dataSet={dataSet} handleChange={handleChange} />
        <Gap />
        <Signing out dataSet={dataSet} handleChange={handleChange} />
        <Gap />
